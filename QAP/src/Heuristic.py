...
class TabuSearch(Heuristic):
    ...
    def run(self, objective_fn, neighborhood_fn, initial_sol, params):
        [p_time, distances, flows] = params

        # Generate an initial solution
        best = initial_sol
        # Evaluate the initial solution
        best_eval = objective_fn(best, distances, flows)
        ...
        for i in range(self.n_iterations):
            ...
            for neighbor in neighbors:
                ...
                neighbor_eval = objective_fn(neighbor, distances, flows)
...
class SimulatedAnnealing(Heuristic):
    def run(self, objective_fn, neighborhood_fn, initial_sol, params):
        [L, initial_temp, distances, flows] = params
